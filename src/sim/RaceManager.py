...
class RaceManager:
    def __init__(
        ...
        pit_loss: float,
        pit_speed: float,
        starting_grid: list | None = None,
        circuit_characteristics: dict | None = None,
        seed: int | None = None,
    ...
    def finalise_lap_if_crossed(
        self,
        car: CarAgent,
        crossed_line: bool,
        apply_tyre_wear: bool,
        completed_lap_time: float | None = None,
        next_lap_carry_time: float = 0.0,
    ) -> None:
        if not crossed_line:
            return
